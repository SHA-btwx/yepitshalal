...
function allowedByRobots(rules, pathname) {
  let best = null;
...
function excerptsAround(text, pattern, width = 150, max = 8) {
  const out = [];
...
const CONTRADICTIONS = {
  pork: /\bpork\b/i,
  bacon: /\b(?<!(turkey|beef|chicken|veal|halal|veggie|vegan|vegetarian|facon)\s)bacon\b/i,
...
const CERTIFIER = /\b(HMC|HFA|halal monitoring committee|halal food authority|halal certified|certified halal|halal certification|halal certificate)\b/i;
