...
interface Offer {
  ...
  /** Restaurants sometimes want to thank supporters specifically. */
  ...
  return (
    <section className="rounded-2xl border border-line bg-white p-5 shadow-sm">
      ...
      <ul className="mt-3 space-y-3">
        {offers.map((offer) => {
          const supportersOnly = offer.yep_plus_only && !offer.voucher_code;
          return (
            <li key={offer.id} className="rounded-xl border border-line p-3.5">
              ...
              {offer.voucher_code ? (
                ...
                >
                  ...
                  The restaurant is offering this to supporters
                </a>
              ) : null}
            </li>
          );
